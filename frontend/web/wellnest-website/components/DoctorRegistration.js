            ...
            <div className="max-w-4xl mx-auto animate-[fadeInUp_0.8s_ease-out]">
                ...
                >
                    ...
                    focus:outline-none focus:border-emerald-500 focus:bg-white focus:shadow-lg focus:shadow-emerald-500/10"
                            ...
                            {/* Password */}
                            <div>
                                <label className="block text-sm font-semibold text-emerald-900 mb-2">Password *</label>
                                <input
                                    type="password"
                                    name="password"
                ...
                hover:shadow-xl hover:shadow-emerald-500/25 focus:outline-none focus:ring-4 focus:ring-emerald-500/50"
                        >
